package org.sharan.soa.messenger.resources;
...
import org.sharan.soa.messenger.service.ProfileService;
...
public class ProfileResource {
	...
	@POST
	public Profile allProfile(Profile p) {
	...
	public void deleteProfile(@PathParam("profileName") String profileName) {
		LOG.log(Level.INFO, profileName);
